...
from google.cloud.contact_center_insights_v1.services.contact_center_insights import ContactCenterInsightsAsyncClient
...
from google.cloud.contact_center_insights_v1.services.contact_center_insights import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ContactCenterInsightsClient, transports.ContactCenterInsightsRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ContactCenterInsightsClient, transports.ContactCenterInsightsRestTransport, "rest", "true"),
    (ContactCenterInsightsClient, transports.ContactCenterInsightsRestTransport, "rest", "false"),
])
@mock.patch.object(ContactCenterInsightsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ContactCenterInsightsClient))
@mock.patch.object(ContactCenterInsightsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ContactCenterInsightsAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    ContactCenterInsightsClient, ContactCenterInsightsAsyncClient
])
@mock.patch.object(ContactCenterInsightsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ContactCenterInsightsClient))
@mock.patch.object(ContactCenterInsightsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ContactCenterInsightsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ContactCenterInsightsClient, transports.ContactCenterInsightsGrpcTransport, "grpc", grpc_helpers),
    (ContactCenterInsightsAsyncClient, transports.ContactCenterInsightsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ContactCenterInsightsClient, transports.ContactCenterInsightsRestTransport, "rest", None),
])
...
def test_bulk_analyze_conversations(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.bulk_analyze_conversations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_bulk_analyze_conversations_flattened():
    ...
    with mock.patch.object(
        ...
        assert arg == mock_val
        assert math.isclose(args[0].analysis_percentage, 0.20170000000000002, rel_tol=1e-6)
...
def test_ingest_conversations(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.ingest_conversations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_issue_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_issue_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_issue_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_issue_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_issue_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_issue_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_deploy_issue_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.deploy_issue_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_undeploy_issue_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undeploy_issue_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_issue(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_issue),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.Issue(
            name='name_value',
...
def test_delete_issue(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_issue),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
async def test_list_phrase_matchers_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_phrase_matchers(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_update_phrase_matcher(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_phrase_matcher),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.PhraseMatcher(
            name='name_value',
...
def test_list_views_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.View)
                   for i in results)
...
def test_create_conversation_rest_interceptors(null_interceptor):
    transport = transports.ContactCenterInsightsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ContactCenterInsightsRestInterceptor(),
        )
    client = ContactCenterInsightsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_create_conversation") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_create_conversation") as pre:
...
def test_update_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_update_conversation") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_update_conversation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_conversation") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_conversation") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_conversations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = contact_center_insights.ListConversationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_list_conversations") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_list_conversations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_conversation_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_delete_conversation") as pre:
        pre.assert_not_called()
...
def test_create_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_create_analysis") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_create_analysis") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_analysis") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_analysis") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_analyses_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_list_analyses") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_list_analyses") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_analysis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_delete_analysis") as pre:
        pre.assert_not_called()
...
def test_bulk_analyze_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_bulk_analyze_conversations") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_bulk_analyze_conversations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_ingest_conversations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_ingest_conversations") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_ingest_conversations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_export_insights_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_export_insights_data") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_export_insights_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_issue_model_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["issue_model"] = {'name': 'name_value', 'display_name': 'display_name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'issue_count': 1201, 'state': 1, 'input_data_config': {'medium': 1, 'training_conversations_count': 3025, 'filter': 'filter_value'}, 'training_stats': {'analyzed_conversations_count': 3021, 'unclassified_conversations_count': 3439, 'issue_stats': {}}}
    request = request_type(**request_init)
...
def test_create_issue_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_create_issue_model") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_create_issue_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_issue_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_update_issue_model") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_update_issue_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_issue_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_issue_model") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_issue_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_issue_models_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = contact_center_insights.ListIssueModelsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_issue_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_list_issue_models") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_list_issue_models") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_issue_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_delete_issue_model") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_delete_issue_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_deploy_issue_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_deploy_issue_model") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_deploy_issue_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_undeploy_issue_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_undeploy_issue_model") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_undeploy_issue_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_issue_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_issue") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_issue") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_issues_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_list_issues") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_list_issues") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_issue_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_update_issue") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_update_issue") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_issue_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_delete_issue") as pre:
        pre.assert_not_called()
...
def test_calculate_issue_model_stats_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = contact_center_insights.CalculateIssueModelStatsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_calculate_issue_model_stats_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_calculate_issue_model_stats") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_calculate_issue_model_stats") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_phrase_matcher_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_create_phrase_matcher") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_create_phrase_matcher") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_phrase_matcher_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_phrase_matcher") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_phrase_matcher") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_phrase_matchers_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = contact_center_insights.ListPhraseMatchersResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_phrase_matchers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_list_phrase_matchers") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_list_phrase_matchers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_phrase_matcher_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_delete_phrase_matcher") as pre:
        pre.assert_not_called()
...
def test_update_phrase_matcher_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_update_phrase_matcher") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_update_phrase_matcher") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_calculate_stats_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = contact_center_insights.CalculateStatsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_calculate_stats_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_calculate_stats") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_calculate_stats") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_settings") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_settings_rest(request_type):
    ...
    request_init["settings"] = {'name': 'projects/sample1/locations/sample2/settings', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'language_code': 'language_code_value', 'conversation_ttl': {'seconds': 751, 'nanos': 543}, 'pubsub_notification_settings': {}, 'analysis_config': {'runtime_integration_analysis_percentage': 0.4167, 'annotator_selector': {'run_interruption_annotator': True, 'run_silence_annotator': True, 'run_phrase_matcher_annotator': True, 'phrase_matchers': ['phrase_matchers_value1', 'phrase_matchers_value2'], 'run_sentiment_annotator': True, 'run_entity_annotator': True, 'run_intent_annotator': True, 'run_issue_model_annotator': True, 'issue_models': ['issue_models_value1', 'issue_models_value2']}}}
    request = request_type(**request_init)
...
def test_update_settings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_update_settings") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_update_settings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_create_view") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_create_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_get_view") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_get_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_views_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_list_views") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_list_views") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "post_update_view") as post, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_update_view") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_view_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ContactCenterInsightsRestInterceptor, "pre_delete_view") as pre:
        pre.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (ContactCenterInsightsAsyncClient, transports.ContactCenterInsightsGrpcAsyncIOTransport),
])
